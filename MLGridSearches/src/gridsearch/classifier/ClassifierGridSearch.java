...
public class ClassifierGridSearch {
	public static void main(final String[] args) throws ExperimentDBInteractionFailedException, IllegalExperimentSetupException, IOException, ExperimentAlreadyExistsInDatabaseException {
